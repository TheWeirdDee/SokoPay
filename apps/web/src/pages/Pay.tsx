  ...
  return (
    <div className="min-h-screen bg-bg p-6 max-w-[430px] mx-auto border-x border-border shadow-2xl relative pb-24 font-body">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="font-display text-2xl font-bold">Pay</h1>
      </div>
      <div className="bg-bg-card border-2 border-border p-6 rounded-xl shadow-card text-center text-text-muted space-y-4">
        <div className="text-4xl">💸</div>
        <p className="font-semibold text-text">Make a Payment</p>
        <p className="text-xs">Send money to other merchants or withdraw funds. Payment features coming in the next build stage.</p>
      </div>
    </div>
  );
}
